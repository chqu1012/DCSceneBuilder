...
public class MmDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MmDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEmfModelAccess().getGroup_6_3(), "rule__EmfModel__Group_6_3__0");
			builder.put(grammarAccess.getEmfModelAccess().getGroup_7(), "rule__EmfModel__Group_7__0");
			...
			builder.put(grammarAccess.getEmfModelAccess().getNameAssignment_4_1(), "rule__EmfModel__NameAssignment_4_1");
			builder.put(grammarAccess.getEmfModelAccess().getControllerAssignment_5_1(), "rule__EmfModel__ControllerAssignment_5_1");
			builder.put(grammarAccess.getEmfModelAccess().getStyleClassAssignment_6_2(), "rule__EmfModel__StyleClassAssignment_6_2");
			builder.put(grammarAccess.getEmfModelAccess().getStyleClassAssignment_6_3_1(), "rule__EmfModel__StyleClassAssignment_6_3_1");
			builder.put(grammarAccess.getEmfModelAccess().getRootAssignment_7_1(), "rule__EmfModel__RootAssignment_7_1");
