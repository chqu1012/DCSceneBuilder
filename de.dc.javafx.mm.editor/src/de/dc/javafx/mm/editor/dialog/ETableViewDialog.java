...
public class ETableViewDialog extends TitleAreaDialog {
	...
	public ETableViewDialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		txtTableViewId = new Text(container, SWT.BORDER);
