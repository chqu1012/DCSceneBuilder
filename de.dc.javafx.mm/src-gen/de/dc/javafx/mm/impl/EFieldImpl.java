...
public class EFieldImpl extends MinimalEObjectImpl.Container implements EField {
	...
	protected EClass eStaticClass() {
		return MmPackage.Literals.EFIELD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MmPackage.EFIELD__NAME, oldName, name));
	}
	...
	public void setDatatype(String newDatatype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MmPackage.EFIELD__DATATYPE, oldDatatype, datatype));
	}
