...
/**
 * This is the item provider adapter for a {@link de.dc.javafx.mm.EEvents} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EEventsItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public EEventsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EEvents"));
	}
	...
	public String getText(Object object) {
		String label = ((EEvents) object).getOnAction();
		return label == null || label.length() == 0 ? getString("_UI_EEvents_type")
				: getString("_UI_EEvents_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EEvents.class)) {
